        ...
        <div className="space-y-3">
          ...
          >
            <button
              ...
              className="flex shrink-0 items-center gap-2 rounded-md bg-[var(--text-primary)] px-3 py-1.5 text-xs font-medium text-[var(--bg-primary)] hover:brightness-110 disabled:opacity-50"
            >
              {isLinearConnecting && (
